...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.showUserInfo = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, result, token, data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    UserStore.prototype.createUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql_checkExist, existedUser, sql_insert, hash, result, createdUser, token, data, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, connection.query(sql_insert, [
                                user.fistName,
                                user.lastName,
                                user.userName,
                                hash,
    ...
    UserStore.prototype.authenticate = function (userName, password) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, result, user, token, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
