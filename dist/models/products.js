...
var ProductStore = /** @class */ (function () {
    ...
    // @ts-ignore
    ProductStore.prototype.showProductInfo = function (product_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        sql = "SELECT * FROM products WHERE id = ".concat(product_id);
                        return [4 /*yield*/, connection.query(sql)];
                    case 2:
                        result = _a.sent();
    ...
    ProductStore.prototype.createProduct = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var newProduct, connection, sql, result, createdProduct, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    ProductStore.prototype.getProductByCategory = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, result, productByCategory, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        connection = _a.sent();
                        sql = "SELECT * FROM products WHERE category LIKE '%".concat(category, "%'");
                        return [4 /*yield*/, connection.query(sql)];
                    case 2:
                        result = _a.sent();
                        if (result && result.rows.length > 0) {
                            productByCategory = result.rows;
                            return [2 /*return*/, productByCategory];
                        }
                        else {
                            connection.release();
                            throw new Error("Data Not Found");
